...
const Dictionary = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      setWordData(null);
      setError(
        "We couldn't find that word in our dictionary. Try another word!"
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="min-h-screen p-4 bg-gradient-to-b from-blue-100 to-blue-50">
      <header className="flex justify-between items-center mb-8">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-kid-blue">
          Dictionary
        </h1>
      ...
      <div className="max-w-2xl mx-auto mb-8">
        <Card className="kid-bubble border-kid-blue mb-6">
          <CardContent className="pt-6">
            ...
            <p className="text-gray-600">
              This dictionary is designed for children and filters out
              inappropriate content. Some words or definitions may not be
              available, but some proper words that might be inappropriate to
              some are available.
            </p>
          </CardContent>
        </Card>
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            className="bg-kid-blue hover:bg-kid-blue/80 rounded-full w-14 h-14 p-0"
          >
            <Search size={24} />
          </Button>
        </div>
            ...
            <CardContent>
              <div className="flex flex-wrap gap-4 mb-4">
                {splitIntoSyllables(wordData.word).map((syllable, i) => (
                  <Card
                    key={i}
                    className="p-4 bg-kid-green/10 border-kid-green/30"
                  >
